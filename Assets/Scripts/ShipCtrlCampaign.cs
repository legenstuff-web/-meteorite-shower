...
public class ShipCtrlCampaign : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            InvokeRepeating("SpawnMeteor", 0.5f, 0.5f);
        }
        else if (PlayerPrefs.GetInt("Difficulty") == 2 || PlayerPrefs.GetInt("Difficulty") == 3)
        {
            InvokeRepeating("SpawnMeteor", 0.25f, 0.25f);
        }
        else if (PlayerPrefs.GetInt("Difficulty") == 4)
        {
            InvokeRepeating("SpawnMeteor", 0.15f, 0.15f);
        }
    }
    ...
    void SpawnMeteor()
    {
        ...
        if (random2 == 0)
        {
            NewMeteor.GetComponent<MeteorCtrlCampaign>().target = new Vector2(Camera.main.aspect * Camera.main.orthographicSize * -1, Random.Range(Camera.main.orthographicSize * -1, Camera.main.orthographicSize));
        }
        if (random2 == 1)
        {
            NewMeteor.GetComponent<MeteorCtrlCampaign>().target = new Vector2(Camera.main.aspect * Camera.main.orthographicSize, Random.Range(Camera.main.orthographicSize * -1, Camera.main.orthographicSize));
        }
        if (random2 == 2)
        {
            NewMeteor.GetComponent<MeteorCtrlCampaign>().target = new Vector2(Random.Range(Camera.main.aspect * Camera.main.orthographicSize * -1, Camera.main.aspect * Camera.main.orthographicSize), Camera.main.orthographicSize * -1);
        }
        if (random2 == 3)
        {
            NewMeteor.GetComponent<MeteorCtrlCampaign>().target = new Vector2(Random.Range(Camera.main.aspect * Camera.main.orthographicSize * -1, Camera.main.aspect * Camera.main.orthographicSize), Camera.main.orthographicSize);
        }
    }
    ...
    public void Destroyself()
    {
        ...
        GameObject.Find("Canvas").GetComponent<TimeCtrlCampaign>().GameOverScreen(false);
    }
}